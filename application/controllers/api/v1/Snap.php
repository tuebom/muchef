	...
	public function finish()
	{
		...
		switch ($result->payment_type) {
			...
			case 'bca_klikpay':
				...
				break;
			case 'bca_klikbca':
				$payment_type = 'KlikBCA';
				$bank         = 'BCA';
				$va_number    = '';
				break;
			case 'bri_epay':
				$payment_type = 'e-Pay BRI';
				$bank         = 'BRI';
				$va_number    = '';
				break;
			case 'mandiri_clickpay':
				$payment_type = 'Mandiri Clickpay';
				$bank         = 'Mandiri';
				$va_number    = '';
				break;
			case 'cimb_clicks':
				$payment_type = 'CIMB Clicks';
				$bank         = 'CIMB';
				$va_number    = '';
				break;
			case 'telkomsel_cash':
				$payment_type = 'Telkomsel Cash';
				$bank         = '';
				$va_number    = '';
				break;
			case 'echannel':
				$payment_type = 'E-Channel';
				$bank         = '';
				$va_number    = '';
				break;
			case 'indosat_dompetku':
				$payment_type = 'Indosat Dompetku';
				$bank         = '';
				$va_number    = '';
				break;
			case 'mandiri_ecash':
				$payment_type = 'Mandiri E-Cash';
				$bank         = 'Mandiri';
				$va_number    = '';
				break;
			case 'cstore':
