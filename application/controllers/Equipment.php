...
class Equipment extends Public_Controller {
	...
	{
		$this->session->set_userdata('context', 1);
		$this->data['context']  = 1;
		$this->data['golongan'] = $this->golongan_model->get_all(1);

		foreach ($this->data['golongan'] as $item) {
			$this->data['item_'.$item->kdgol] = $this->golongan_model->get_sample($item->kdgol);
		}
		
		$this->data['banner'] = $this->banner_model->get_all(1);
