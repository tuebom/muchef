							...
							<div class="footer-grids">
								...
								<div class="col-md-3 footer-grid foot" data-step="4" data-tooltipclass='forLastStep' data-intro="You can follow our social media and contact us via email">
									...
									<div class="social-icon">
										...
										<?php else: ?>
										<a href="http://www.facebook.com/asoviconline" target="_blank"><i class="icon"></i></a>
										<a href="http://www.instagram.com/askitchen.utensil" target="_blank"><i class="icon1"></i></a>
										<?php endif; ?>
									</div>
									...
									<div class="contact-icon">
										...
										<?php else: ?>
										<a href="<?php echo site_url('contact-us'); ?>"><i class="icon"></i></a>
										<a href="https://wa.me/628170727857" target="_blank"><i class="icon1"></i></a>
										<?php endif; ?>
									</div>
								</div>
