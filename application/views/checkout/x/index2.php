                                ...
                                <div class="row">
                                    <div class="col-sm-6">    
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <option value="<?= $item->id ?>"<?php if( $_SESSION['district'] == $item->id ): ?> selected<?php endif; ?>><?= $item->name ?></option>
                                            <?php   }
                                                endif;
                                            ?>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">    
                                        <div class="form-group">
                                            ...
                                            <?php } ?>
                                            <!-- <option value="jne"<?php if( $_SESSION['carrier'] == 'jne' ): ?> selected<?php endif; ?>>JNE</option>
                                            <option value="jnt"<?php if( $_SESSION['carrier'] == 'jnt' ): ?> selected<?php endif; ?>>JNT</option>
                                            <option value="lion"<?php if( $_SESSION['carrier'] == 'lion' ): ?> selected<?php endif; ?>>LION</option>
                                            <option value="pos"<?php if( $_SESSION['carrier'] == 'pos' ): ?> selected<?php endif; ?>>POS</option>
                                            <option value="wahana"<?php if( $_SESSION['carrier'] == 'wahana' ): ?> selected<?php endif; ?>>WAHANA</option> -->
                                            </select>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
