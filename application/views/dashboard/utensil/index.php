		...
		<!--content-->
						...
						<div class="col-md-4 arrival-grid simpleCart_shelfItem">
							<div class="grid-arr-hot">
								<a href="<?php echo site_url('new-products'); ?>" class="new-gri">
									<img src="<?=site_url('images/nputensil.jpg');?>" class="img-hot" alt="">
									<div class="text">
										<h3>New Products</h3>
									</div>
								</a>		
						...
						<div class="col-md-4 arrival-grid simpleCart_shelfItem">
							<div class="grid-arr-hot">
								<a href="<?php echo site_url('promotion'); ?>" class="new-gri">
									<img src="<?=site_url('images/promoutensil.jpg');?>" class="img-hot" alt="">
									<div class="text">
										<h3>Promotions</h3>
									</div>
								</a>		
						...
						<div class="col-md-4 arrival-grid simpleCart_shelfItem">
							<div class="grid-arr-hot">
								<a href="<?php echo site_url('best-seller'); ?>" class="new-gri">
									<img src="<?=site_url('images/bsutensil.jpg');?>" class="img-hot" alt="">
									<div class="text">
										<h3>Best Seller</h3>
									</div>
								</a>		
			...
			<!--new-arrivals-->
				<div class="new-arrivals-w3agile">
					<div class="container">
						<h4 class="tittle1">Best Item for You</h4>
						<div class="arrivals-grids">
							<?php
