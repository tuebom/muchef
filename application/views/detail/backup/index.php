					...
					<div class="single-grids">
						<div clas="single-top">
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="row">
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="<?=base_url($this->data['products_dir'].'/'.$product->gambar);?>">
												<div class="thumb-image"> <img src="<?=base_url($this->data['products_dir'].'/'.$product->gambar);?>" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<?php if($product->gambar2): ?>
											<li data-thumb="<?=base_url($this->data['products_dir'].'/'.$product->gambar2);?>">
												<div class="thumb-image"> <img src="<?=base_url($this->data['products_dir'].'/'.$product->gambar2);?>" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<?php endif; if($product->gambar3): ?>
											<li data-thumb="<?=base_url($this->data['products_dir'].'/'.$product->gambar3);?>">
												<div class="thumb-image"> <img src="<?=base_url($this->data['products_dir'].'/'.$product->gambar3);?>" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<?php endif; ?>
										</ul>
									</div>
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								...
								<h4><?= $product->nama . '<br>('. $product->kdbar .')' ?></h4>
								<div class="block">
									<div class="starbox small ghosting unchangeable" data-start-value="<?= $this->data['item_rating']->rating ?>"> </div>
								</div>
								<?php if ($product->pnj) { ?>
								<span class="size"><?= $product->pnj; ?> x <?= $product->lbr; ?> x <?= $product->tgi; ?> CM</span><br>
								<?php } if ($product->size) { ?>
								...
								<?php else :?>
								<p class="price item_price">Rp <?= $product->hjual ?></p>
								<?php endif; ?>
								...
								<!--<div class="color-quality">
									...
									<select id="size" name="size" class="form-control">
										<?php
											foreach ($this->data['size'] as $item) {
												if (isset($_SESSION['size']))
												{
										?>
										<option value="<?= $item->size ?>"<?php if( $item->size == $_SESSION['size'] ): ?> selected="selected"<?php endif; ?>><?= $item->size ?></option>
										<?php   } else { ?>
