								...
								<ul class="nav nav-product-pills nav-fill" style="width:100%; align-items:center; display: flex;">
									...
									$( function() {
										...
										$( "#slider-range" ).mouseup(function(){
											...
											var theUrl = <?php echo '"'.site_url().'search?q='.$q.'"' ?>;
									...
									<div class="col-md-3 product-tab-grid simpleCart_shelfItem">
										<div class="grid-arr">
											...
											<div class="dashboard">
												...
												<a href="<?php echo site_url('detail/'.$item->kdurl); ?>"><img class="buyonline" src="<?= site_url('images/buy-online.jpg'); ?>" alt="Buy online" /></a>
											</div>
