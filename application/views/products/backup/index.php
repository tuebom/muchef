        ...
        <div class="content">
				<div class="products-agileinfo">
					...
					<?php endif; ?>
							...
							<div class="col-md-10 product-agileinfon-grid1 w3l">
												...
												<div class="col-md-3 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														...
														<div class="dashboard">
															...
															<span class="size"><?= $item->nama; ?></span><!--<?=$_SESSION["display_master"]?>-->
															<?php if($item->pnj): ?>
															<div class="dimensi">
																<span class="size"><?= $item->pnj; ?> x <?= $item->lbr; ?><?= ($item->tgi)?' x '.$item->tgi:''; ?></span>
															</div><?php endif; ?>
															<?php if($_SESSION["display_master"]) {
																if ($item->master == 'N') :
															?><div class="harga">
																<span class="detail">Rp<?= $item->hjual; ?><a href="<?= current_url().'?action=add&code='.$item->kdurl ?>" class="my-cart-product item_add"><img src="<?= site_url('images/bag.png'); ?>" alt="Cart" /></a>
															</div><?php 
																endif; } else { ?>
															<div class="harga">
																<span class="detail">Rp<?= $item->hjual; ?><a href="<?= current_url().'?action=add&code='.$item->kdurl ?>" class="my-cart-product item_add"><img src="<?= site_url('images/bag.png'); ?>" alt="Cart" /></a>
