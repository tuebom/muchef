            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Users - Delete</h3>
                    </div>
                    <div class="box-body">

                        <h3 class="box-title">Are you sure you want to delete user <span class="label label-primary"><?=$id['name']?></span></h3>
                        <?php echo form_open("admin/users/delete/".$id['id']);?>
