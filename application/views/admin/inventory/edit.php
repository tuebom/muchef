                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="parent" name="parent" class="form-control">
                                                    <option value=""<?=isset($_SESSION['parent'])?'': ' selected';?>>-</option>
                                                    <?php
                                                        foreach ($parents as $itemx) {
                                                            if (isset($_SESSION['parent']))
                                                            {
                                                    ?>
                                                    <option value="<?= $itemx->kdbar ?>"<?php if( $itemx->kdbar == $_SESSION['parent'] ): ?> selected="selected"<?php endif; ?>><?= $itemx->nama ?></option>
                                                    <?php   } else { ?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="master" value="Y"<?=$master['value'] == 'Y'? ' checked':''?>> Master
                                                </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5 boxpreview">
                                    <div class="form-group">
                                            <?php echo lang('inventory_picture', 'gambar', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                                <?php echo form_input($gambar);?>
                                                <div class="product-img-edit"><img src="<?=site_url($this->data['products_dir'].'/'.$gambar['value'])?>" alt="Image"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="product-img-edit"><img src="<?=site_url($this->data['products_dir'].'/'.$gambar2['value'])?>" alt="Image"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="product-img-edit"><img src="<?=site_url($this->data['products_dir'].'/'.$gambar3['value'])?>" alt="Image"></div>
                                            </div>
                                        </div>
                                        <?php echo form_hidden($old_pic); ?>
                                        <?php echo form_hidden($old_pic2); ?>
                                        <?php echo form_hidden($old_pic3); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <!-- The container for the uploaded files -->
                                            <div id="files" class="files"><div class="product-img-edit"><img src="<?=site_url($this->data['products_dir'].'/'.$gambar['value'])?>" alt="Image"></div></div>
                                            <br><a id="btnDelete" href="#" class="btn btn-sm btn-default btn-flat button-delete">Delete old image</a>&nbsp;
                                            <a id="btnUpload" href="#" class="btn btn-sm btn-default btn-flat button-upload">Choose image
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <!-- The container for the uploaded files -->
                                            <div id="files2" class="files"><div class="product-img-edit"><img src="<?=site_url($this->data['products_dir'].'/'.$gambar2['value'])?>" alt="Image"></div></div>
                                            <br><a id="btnDelete2" href="#" class="btn btn-sm btn-default btn-flat button-delete">Delete old image</a>&nbsp;
                                            <a id="btnUpload3" href="#" class="btn btn-sm btn-default btn-flat button-upload">Choose image
                                            <input id="fileupload2" type="file" name="files[]" multiple></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-2"></div>
                                        <div class="col-sm-10">
                                            <!-- The container for the uploaded files -->
                                            <div id="files3" class="files"><div class="product-img-edit"><img src="<?=site_url($this->data['products_dir'].'/'.$gambar3['value'])?>" alt="Image"></div></div>
                                            <br><a id="btnDelete2" href="#" class="btn btn-sm btn-default btn-flat button-delete">Delete old image</a>&nbsp;
                                            <a id="btnUpload3" href="#" class="btn btn-sm btn-default btn-flat button-upload">Choose image
                                            <input id="fileupload3" type="file" name="files[]" multiple></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $('#btnDelete').click(function(event) {
        ...
        var filename = document.getElementsByName("old_pic2")[0].value;
        if (filename !== '') {
            $.ajax({
                type: "POST",
                url: <?php echo '"'.site_url().'admin/inventory/rmvimage"' ?>,
        ...
        var filename = document.getElementsByName("old_pic3")[0].value;
        if (filename !== '') {
            $.ajax({
                type: "POST",
                url: <?php echo '"'.site_url().'admin/inventory/rmvimage"' ?>,
