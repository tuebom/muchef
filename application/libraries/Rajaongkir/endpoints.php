...
class Endpoints {
    ...
    function cost($origin, $destination, $weight, $courier) {
        $params = array(
            ...
            'weight' => $weight,
            'courier' => $courier,
            'originType' => 'city', //(strlen($origin)==3 && $this->account_type!='pro')?'city':$this->originType,
            'destinationType' => 'city' //(strlen($destination)==3 && $this->account_type!='pro')?'city':$this->originType
        );
